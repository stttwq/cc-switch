# CC Switch 上游 3.x 更新日志（归档）

> 本文件是从上游 [farion1231/cc-switch](https://github.com/farion1231/cc-switch) 继承的历史记录，fork 前的 3.x 及更早版本更新日志原样保留在此，仅作可查归档。
> 本 Windows 专版分支 2.0.0 起的变化见仓库根 [`CHANGELOG.md`](../CHANGELOG.md)。
