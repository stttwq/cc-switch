...
- **Using DeepSeek in Codex: local routing hands-on guide** — uses the built-in DeepSeek preset to walk through adding a Codex provider, enabling local routing, and verifying request forwarding.
