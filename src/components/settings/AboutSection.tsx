    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/stttwq/cc-switch/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/stttwq/cc-switch/releases/tag/${displayVersion}`,
      );
    } catch (error) {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              size="sm"
              onClick={() =>
                settingsApi.openExternal("https://github.com/stttwq/cc-switch")
              }
